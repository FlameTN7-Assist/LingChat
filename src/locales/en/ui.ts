...
export default {
  ...
  toolCalls: {
    ...
    builtinHint: "Search runs server-side on your current chat model API (Kimi/Moonshot or the official DeepSeek API) — it just uses your existing chat key, no separate signup needed",
    apiKey: "API Key",
