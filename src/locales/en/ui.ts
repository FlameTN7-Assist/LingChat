...
export default {
  ...
  toolCalls: {
    ...
    commandAccessByMode: {
      manual: "Ask before every command.",
      auto_approve: "Normal commands run automatically; detected deletion commands still ask.",
      full_access: "⚠ All commands, including deletion commands, can run without confirmation.",
    },
    fileChangeApprovalTitle: "File Change Request",
    ...
    mediaOutputTokens: "Maximum result tokens",
    ...
    groups: {
      ...
      media: "Media Recognition (read images and videos with the vision model)",
