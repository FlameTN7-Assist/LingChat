...
export default {
  ...
  background: {
    ...
    dialog: {
      ...
      description: 'Customize the background, transparency, blur, corner radius, and more for the main interface dialog',
  ...
  llmProviders: {
    ...
    codex: {
      ...
      enterCodeHint: "The authorization page has opened in your browser. Enter this user code to sign in:",
  ...
  tts: {
    ...
    messages: {
      ...
      switchEnabledNotReady: 'Local TTS enabled, but the engine is not ready (DeBERTa model or tokenizer missing. Please download first).',
