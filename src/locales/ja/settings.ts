export default {
  ...
  identity: {
    listTitle: "アイデンティティ管理",
    listHint:
      "プレイヤーのアイデンティティは AI キャラクターとは独立しており、複数の人物設定を持って会話中に切り替えられます。",
    create: "新しいアイデンティティ",
    createTitle: "新しいアイデンティティ",
    editTitle: "アイデンティティを編集",
    edit: "編集",
    delete: "削除",
    empty: "アイデンティティがありません（デフォルトは常に存在します）",
    ...
    messages: {
      loadFailed: "アイデンティティ一覧の読み込みに失敗しました",
      saveFailed: "アイデンティティの保存に失敗しました",
      deleteFailed: "アイデンティティの削除に失敗しました",
      createSuccessTitle: "アイデンティティを作成しました",
      createSuccess: "アイデンティティ「{name}」を作成しました",
      updateSuccessTitle: "アイデンティティを更新しました",
      updateSuccess: "アイデンティティ「{name}」を更新しました",
      deleteSuccessTitle: "アイデンティティを削除しました",
      deleteSuccess: "アイデンティティ「{name}」を削除しました",
      deleteConfirmTitle: "アイデンティティを削除",
      deleteConfirm:
        "アイデンティティ「{name}」を削除しますか？発言はデフォルトのアイデンティティに帰属し、関連する記憶も削除されます。",
    },
  },
  sceneEdit: {
    title: {
  ...
  llmProviders: {
    ...
    form: {
      ...
      supportVisionHint:
        "ONにすると画像・スクリーンショットを直接この対話モデルへ送信し、ナレーターの転述を経由しません",
      visionCompress: "画像認識時に画像を圧縮",
      visionCompressHint:
        "デフォルトはオフで原画像のまま送信。オンにすると辺長と品質を調整でき、トークンとコンテキストキャッシュを節約",
      visionMaxEdge: "最大辺長（ピクセル）",
      visionMaxEdgeHint: "大きい画像はこの辺長に等比縮小されます（64–8192）",
      visionQuality: "エンコード品質（0-100）",
      visionQualityHint: "高いほど鮮明ですがトークン消費も増えます",
      save: "保存",
      cancel: "キャンセル",
    },
    test: {
  ...
  memoryDebug: {
    title: "永続記憶デバッグ",
    rolesTitle: "キャラクター",
    noRoles: "確認できるキャラクターがいません（先にキャラクターを登場させてください）",
    selectRoleHint: "左のキャラクターを選ぶと、その永続記憶とコンテキストを表示します",
    runtimeOn: "記憶オン",
    runtimeOff: "記憶オフ",
    runtimeAbsent: "ランタイム未作成",
    saveBound: "セーブ #{id}",
    saveNone: "フリーチャット：記憶はメモリ上のみで、再起動すると失われます",
    refresh: "更新",
    refreshing: "更新中…",
    triggerTitle: "圧縮の状態（実行時の有効値）",
    triggerHint:
      "しきい値の単位は「そのキャラクターに見える非 System のセリフ」です。他キャラのセリフ・System 行・知覚できないセリフは数えません。",
    triggerProgress: "蓄積 {visible} / しきい値 {interval} 行",
    triggerRemaining: "発火まであと {n} 行",
    triggerReached: "しきい値に到達",
    pointerOutOfRange:
      "圧縮ポインタが範囲外です。次回の発火時に 0 へリセットされます（巻き戻し / ロード / クリアで履歴が短くなるため）",
    runtimeEffective:
      "上の interval / window は実行時の有効値です。設定の変更は再起動後に反映されます。",
    storeTitle: "① 記憶バンク（保存されている実体）",
    storeHint: "完全・切り詰めなし",
    charsOf: "{stored} 文字 / 上限 {limit} 文字",
    charsNoLimit: "{stored} 文字 / 上限なし",
    truncatedTag: "注入時に切り詰め",
    metaLine: "ポインタ {pointer} · 更新 {updated} · schema v{schema}",
    section: {
      short_term: "直近の振り返り（短期要約）",
      long_term: "長期的な出来事",
      user_info: "ユーザー情報",
      promises: "約束",
    },
    injectedTitle: "② 注入ビュー",
    injectedHint: "LLM が実際に受け取る内容（上限で切り詰め済み）",
    injectedSystem: "system 記憶ブロック（短期要約は含まない）",
    injectedShortTerm: "短期振り返りの接頭辞（最初の user の前に付与）",
    injectedShortTermEmpty: "注入なし",
    contextTitle: "③ 実際のコンテキスト",
    contextHint: "全 {n} 件。次回リクエストはこれを基に構築されます",
    contextEmpty: "コンテキストが空です（このキャラクターはまだセリフに参加していません）",
    toolCalls: "ツール呼び出し",
    ...
    stFailCount: "連続失敗",
    stCooldown: "失敗クールダウン",
    stRecentWindow: "保持ウィンドウ",
    stPointer: "ポインタ / 履歴",
    stHistoryRevision: "履歴バージョン",
    enabledOn: "オン",
    enabledOff: "オフ",
    yes: "はい",
    no: "いいえ",
