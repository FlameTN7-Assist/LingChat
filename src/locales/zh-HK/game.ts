// 繁體中文（香港 · 粵語文體）語言包，由 zh-CN/game.ts 翻譯維護
export default {
  dialog: {
    sceneSettings: "場景設定",
    touchMode: "觸摸模式",
    ...
    // 附身切換（玩家側行為）
    possessing: "現正扮演",
    possessGroupIdentities: "我嘅身份",
    possessGroupAiRoles: "AI 角色",
    possessSuccessTitle: "附身切換成功",
  ...
  soundPanel: {
    ...
    modeLoopSingle: "單曲循環",
    modeRandom: "隨機播放",
    selectBgmHint: "去 {link} 揀背景音樂",
    settingsSoundLink: "設定 → 聲音",
    emptyMusicList: "暫時冇音樂",
    noMusic: "未揀音樂",
    ambient: "環境音",
    stopAll: "全部停晒",
