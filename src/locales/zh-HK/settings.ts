...
export default {
  ...
  identity: {
    listTitle: "身份管理",
    listHint: "玩家身份獨立於 AI 角色，可以擁有多套人設並喺對話中切換扮演。",
    create: "新增身份",
    createTitle: "新增身份",
    editTitle: "編輯身份",
    edit: "編輯",
    delete: "刪除",
    empty: "暫時未有身份（預設身份應該一直存在）",
    noSubtitle: "未設定副標題",
    defaultBadge: "預設身份",
    possessedBadge: "現正扮演",
    possess: "扮演",
    possessDisabledInScript: "劇本／試玩進行中唔可以切換扮演",
    defaultDeleteBlocked: "預設身份唔可以刪除",
    fields: {
      name: "名字",
      ...
      prompt: "人設提示詞",
      promptPlaceholder: "描述呢個身份嘅性格、背景同行為方式",
      info: "簡介",
      infoPlaceholder: "可填可唔填：一句話介紹",
      speechExamples: "說話風格",
      speechExamplesPlaceholder: "可填可唔填：示例台詞，等 AI 模仿語氣",
    },
    actions: {
      save: "儲存",
      saving: "儲存緊...",
    ...
    messages: {
      ...
      saveFailed: "儲存身份失敗",
      deleteFailed: "刪除身份失敗",
      createSuccessTitle: "身份建立成功",
      createSuccess: "身份「{name}」已經建立",
      updateSuccessTitle: "身份更新成功",
      updateSuccess: "身份「{name}」已經更新",
      deleteSuccessTitle: "身份已刪除",
      deleteSuccess: "身份「{name}」已經刪除",
      deleteConfirmTitle: "刪除身份",
      deleteConfirm: "確定刪除身份「{name}」？佢嘅發言會歸屬預設身份，相關記憶會一齊清除。",
    },
  },
  sceneEdit: {
    title: {
