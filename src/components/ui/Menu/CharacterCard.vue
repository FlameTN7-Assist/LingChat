      ...
      >
        <div class="flex items-center gap-4 border-b border-white/10 bg-white/10 p-6">
          ...
          <div class="flex-1">
            ...
            <p class="mt-1 text-sm tracking-tighter text-indigo-300">
              {{ $t("ui.characterCard.detailSubtitle") }}
            </p>
          </div>
          <button
            @click="closeDetailModal"
        ...
        <div class="flex-1 space-y-8 overflow-y-auto p-6">
          ...
          <section>
            ...
            <div v-else class="rounded-xl bg-white/5 p-4 text-center text-sm text-white/40 italic">
