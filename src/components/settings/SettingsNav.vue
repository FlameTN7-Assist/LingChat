<template>
  ...
  >
    ...
    >
      ...
      >
        <p class="hidden whitespace-nowrap xl:block">{{ $t("nav.text") }}</p>
      </Button>
      <Button
        ref="backgroundBtn"
        type="nav"
      ...
      >
        <p class="hidden whitespace-nowrap xl:block">{{ $t("nav.background") }}</p>
      </Button>
      <Button
        ref="soundBtn"
        type="nav"
      ...
      >
        <p class="hidden whitespace-nowrap xl:block">{{ $t("nav.sound") }}</p>
      </Button>
      <Button
        ref="historyBtn"
        type="nav"
      ...
      >
        <p class="hidden whitespace-nowrap xl:block">{{ $t("nav.save") }}</p>
      </Button>
      <Button
        ref="advanceBtn"
        type="nav"
      ...
      >
        <p class="hidden whitespace-nowrap xl:block">{{ $t("nav.advance") }}</p>
      </Button>
      <Button
        ref="logBtn"
        type="nav"
